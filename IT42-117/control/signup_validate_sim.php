...
//名前
  ...
  $url="/IT42-117/view/sign_up_sim.php?err={$err}";
...
try {
  ...
  header("Location: /IT42-117/view/signup_comp_sim.php"); //完了メッセージ画面にリダイレクト
  exit();

} catch (\Exception $e) {
  $err2="既に登録済みのメールアドレスです";
  $url="/IT42-117/view/sign_up_sim.php?err2={$err2}";
  header("Location:" .$url);
  exit();
}
