        ...
        <main class="main">
              ...
              <div class="left">
                ...
                <!-- いびつな感じで検索項目ここにいったん入れたけど許してください -->
                    <form id="form1" action="search_view.php" method="post">
                    ...
                    <ul>
                        <li>
                            <a class="nav_furniture" href="../shop_category/interior.php">すべて</a>
                        </li>
                        <li>
                            <a class="nav_furniture" href="../shop_category/sofa.php">ソファー</a>
                        </li>
                        <li>
                            <a class="nav_furniture" href="../shop_category/chair.php">チェア</a>
                        </li>
                        <li>
                            <a class="nav_furniture" href="../shop_category/desk.php">テーブル</a>
                        </li>
                        <li>
                            <a class="nav_furniture" href="../shop_category/chest.php">収納</a>
                        </li>
                        <li>
                            <a class="nav_furniture" href="../shop_category/bed.php">ベッド</a>
                        </li>
                        <li>
                            <a class="nav_furniture" href="../shop_category/kitchen.php">キッチン</a>
                        </li>
                        <li>
                            <a class="nav_furniture" href="../shop_category/other.php">その他</a>
                        </li>
                    </ul>
                </nav>
            </div>
            ...
            <div class="right">
            <div class="product">
                <h2 class="product">検索結果</h2>
                <!-- ここはItemテーブルから商品のカウント数に応じて表示内容が変わるように、PHPでecho "" -->
                <h3><?php echo $record."件の商品があります。" ?></h3>
            </div>
