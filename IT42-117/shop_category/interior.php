  ...
  <div class="wrapper">
   ...
   <header class="header_top">
    ...
    <main class="main">
      ...
      <div class="right">
        <div class="product">
            <h2 class="product">商品一覧</h2>
            <!-- ここはItemテーブルから商品のカウント数に応じて表示内容が変わるように、PHPでecho "" -->
            <h3><?php echo $record1."件の商品があります。" ?></h3>
        </div>
        ...
        <!-- 商品表示エリア -->
        <div class="shelf">
          <?php foreach($tables1 as $table){ ?>
            <div class="item">
              <img src="../interior_img/all_img/<?php echo $table['product_img']; ?>" alt="ベッド_1" class="bet">
              <p class="pdname"><?php echo $table['product_name']; ?></p>
              <p class="price"><?php echo "￥".number_format($table['price']); ?></p>
